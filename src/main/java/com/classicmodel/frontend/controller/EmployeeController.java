...
public class EmployeeController {
	...
	public String view(@PathVariable Integer id, Model model) {
		try {
			...
			// Direct search — avoids fetching all customers and losing the salesRepEmployee
			// link
	...
	@PostMapping("/new")
	public String create(@RequestParam Integer employeeNumber, @RequestParam String lastName,
			@RequestParam String firstName, @RequestParam String extension, @RequestParam String email,
			@RequestParam String jobTitle, @RequestParam(required = false) String officeCode,
			@RequestParam(required = false) String managerNumber, RedirectAttributes redirectAttributes) {
		try {
	...
	@PostMapping("/{id}/edit")
	public String update(@PathVariable Integer id, @RequestParam String lastName, @RequestParam String firstName,
			@RequestParam String extension, @RequestParam String email, @RequestParam String jobTitle,
			@RequestParam(required = false) String officeCode, @RequestParam(required = false) String managerNumber,
