...
public class CustomerDto {
    ...
    public EmployeeDto getSalesRepEmployee() { return salesRepEmployee; }
    public void setSalesRepEmployee(EmployeeDto salesRepEmployee) { this.salesRepEmployee = salesRepEmployee; }
}
